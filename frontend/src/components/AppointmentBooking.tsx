...
function AppointmentBooking({
  ...
  const [insuranceActive, setInsuranceActive] = useState<boolean | null>(
    null
  );
  ...
  const eligibilityState = useMemo(() => {
    ...
    if (loadingPatientProfile || loadingReferral) {
      return {
        ...
        detail:
          "Reviewing your patient profile and booking requirements.",
      };
    }
    ...
    if (!canBookAppointment()) {
      if (referralStatus === "missing") {
        return {
          ...
          detail:
            "This appointment has an additional booking requirement that must be completed before booking.",
        };
      }
      ...
      if (referralStatus === "invalid") {
        return {
          ...
          detail:
            "The required booking information was not found for the selected specialist and date.",
        };
      }
      ...
      if (referralStatus === "authorization_required") {
        return {
          ...
          detail:
            "An additional authorization requirement must be completed before this appointment can be booked.",
        };
      }
    ...
    const fetchReferral = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            data.detail ||
              "Unable to complete the booking requirement check."
          );
        }
        ...
        const validReferral = specialistReferrals.find(
          (referral) => {
        ...
        console.error(
          "Error checking booking requirements:",
          err
        );
  ...
  /*
   * Keep the confirmation modal above the complete application.
   * Because the modal is rendered into document.body through a portal,
   * locking body scroll prevents the underlying patient page from
   * moving while the confirmation dialog is open.
   */
  useEffect(() => {
    if (!showConfirmation) {
      return;
  ...
  const handleContinueToReview = () => {
    if (
      ...
      setError(
        "Please select a doctor, date and available time."
      );
      return;
    }
    ...
    if (
      ...
      setError(
        "Please wait while we finish checking your booking information."
      );
      return;
    }
    ...
    if (!coverageReady) {
      setError(
        "Please confirm whether your insurance is currently active."
      );
      return;
    }
  ...
  const appointmentDuration = selectedTime
    ? Math.max(
        0,
        Number(
          selectedTime.end_time.split(":")[0]
        ) *
          60 +
          Number(
            selectedTime.end_time.split(":")[1]
          ) -
          (Number(
            selectedTime.start_time.split(":")[0]
          ) *
            60 +
            Number(
              selectedTime.start_time.split(":")[1]
            ))
      )
    : 0;
    ...
    <div className="appointment-booking">
      <div className="booking-header">
        <div>
          ...
          <p>
            Choose your doctor, review live
            availability, confirm your coverage
            details, and securely submit the
            appointment request.
          </p>
        </div>
        ...
        {[
          ...
          ([key, number, label], index) => {
            ...
            return (
              ...
              >
                <div
                  className={`booking-progress-node ${
                    active ? "active" : ""
                  } ${
                    complete ? "complete" : ""
                  }`}
      ...
      {success && (
        <div
          className="booking-alert success"
          role="status"
        >
          <span className="booking-alert-icon">
            ✓
                    ...
                    {availability.slots.length >
                      ...
                      <div className="slot-expander">
                        ...
                        >
                          {showAllSlots
                            ? "Show fewer times"
                            : `Show ${hiddenSlotCount} more time${
                                hiddenSlotCount ===
                                1
                                  ? ""
                                  : "s"
                      ...
                      <div className="no-availability">
                        ...
                        <span>
                          {availability.message ||
                            "Try another date to find an available appointment."}
                        </span>
                      </div>
                    )}
                  </>
        ...
        step === "coverage" && (
          <section className="coverage-panel active">
            <div className="coverage-header">
              ...
              <div
                className={`eligibility-pill ${eligibilityState.tone}`}
              >
                <span />
            ...
            <div className="coverage-grid">
              <div className="coverage-card">
                <span className="coverage-card-label">
                  INSURANCE ON FILE
                </span>
            ...
            <div
              className={`eligibility-detail ${eligibilityState.tone}`}
            >
              <div className="eligibility-detail-icon">
                {eligibilityState.tone ===
                "ready"
                  ? "✓"
                  : eligibilityState.tone ===
                    "loading"
            ...
            <div className="coverage-trust-note">
              ...
              <p>
                Your member ID is masked in
                this booking screen. Patient
                confirmation is stored only as
                part of this booking session and
                is not a payer eligibility
                response.
              </p>
            </div>
          ...
          <section className="review-panel">
            ...
            <div className="review-layout">
              ...
              <div className="review-side-card">
                ...
                <p>
                  Final booking is subject to
                  the server confirming that
            ...
            >
              ...
              <div className="confirmation-top">
                ...
                <p id="booking-confirm-description">
                  ...
                  details below. The slot will be
                  submitted to the scheduling
                  system.
                </p>
              </div>
              ...
              <div className="confirmation-note">
                ...
                <p>
                  ...
                  created after the scheduling
                  server confirms the slot is
                  still available.
                </p>
              </div>
